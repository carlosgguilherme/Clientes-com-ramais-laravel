                    ...
                    <form class="form-floating" action="{{ route('ramais.update', $ramais->id) }}" method="post"
                        ...
                        <div class="col-md-6 ConteudoCard">
                            ...
                            <div class="form-floating">
                                ...
                                <option value="WEB" @php if ($ramais['tipo'] == 'WEB') {
                                    echo 'selected';
                                } @endphp>WEB</option>
                                <option value="SIP" @php if ($ramais['tipo'] == 'SIP') {
                                    echo 'selected';
                                } @endphp>SIP</option>
                            </select>
                            ...
                            <div class="form-floating">
                                ...
                                <select class="form-select form-floating" id="floatingSelect"
                                    ...
                                    <option value="{{$cliente->id}}" @if ($cliente->id === $ramais->cliente_id) {{ 'selected'; }} @endif >{{$cliente->nome}}</option>
                                @endforeach
                                </select>
